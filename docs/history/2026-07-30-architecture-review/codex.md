...
1. **[critical] Normal 100-post conversations exceed D1’s binding limit after X has already charged for the reads.**  
   src/server/app.ts:84, src/server/app.ts:93, src/server/store-d1.ts:140, src/server/store-d1.ts:146, src/server/xapi.ts:326
...
2. **[major] “Full archive” loads currently cover only X’s default 30-day window.**  
   src/server/xapi.ts:314, src/server/xapi.ts:327
...
3. **[major] `MAX_POSTS_PER_FETCH` is not a hard spending boundary.**  
   src/server/xapi.ts:10, src/server/xapi.ts:329, src/server/xapi.ts:352, src/server/worker.ts:43, src/server/index.ts:8
...
4. **[major] Cost reporting is neither complete nor durable, despite being typed and displayed as actual cost.**  
   src/server/app.ts:54, src/server/app.ts:91, src/server/app.ts:95, src/server/xapi.ts:326, src/shared/types.ts:78
...
5. **[major] Cache and consent paths can silently spend money while claiming “cached” or “free.”**  
   src/server/app.ts:430, src/server/app.ts:437, src/server/app.ts:442, src/server/app.ts:390, src/web/Inbox.tsx:270, src/web/App.tsx:91
...
6. **[major] Truncation is transient and an incomplete conversation cannot be resumed.**  
   src/shared/types.ts:70, src/server/app.ts:37, src/server/app.ts:49, src/server/app.ts:487, src/server/app.ts:501, src/server/storage.ts:77
...
7. **[major] Bookmark reconciliation mistakes capped or failed hydration for un-bookmarking.**  
   src/server/xapi.ts:248, src/server/xapi.ts:252, src/server/xapi.ts:269, src/server/app.ts:201, src/server/app.ts:204, src/server/app.ts:213
...
8. **[major] Single-use refresh-token rotation is not serialized, and every rotation discards cached token metadata.**  
   src/server/oauth.ts:123, src/server/oauth.ts:147, src/server/oauth.ts:167, src/server/oauth.ts:185
...
9. **[major] Row-at-a-time repository calls are poorly shaped for D1.**  
   src/server/app.ts:220, src/server/app.ts:235, src/server/app.ts:295, src/server/app.ts:307, src/server/app.ts:319, src/server/app.ts:404
...
10. **[major] Frontend requests and optimistic mutations can overwrite newer state.**  
    src/web/App.tsx:43, src/web/App.tsx:48, src/web/App.tsx:64, src/web/App.tsx:169, src/web/App.tsx:172
...
11. **[major] “Load 10 more” rescans the own-post timeline from the beginning.**  
    src/server/app.ts:326, src/server/app.ts:335, src/server/app.ts:339, src/web/Inbox.tsx:181, src/web/Inbox.tsx:331
...
12. **[major] Cost-sensitive boundaries rely on TypeScript assertions rather than runtime validation.**  
    src/server/app.ts:179, src/server/app.ts:328, src/server/app.ts:431, src/server/app.ts:526, src/server/xapi.ts:180
...
13. **[major] There is no executable specification for the complex or runtime-sensitive behavior.**  
    package.json:6, src/web/tree.ts:224, src/server/storage.ts:23
...
14. **[minor] Cloudflare Access is fail-closed only when both configuration values remain present.**  
    src/server/access.ts:33, src/server/access.ts:41, src/server/worker.ts:28
...
15. **[minor] X response normalization and bookmark semantics are inconsistent across modules.**  
    src/server/xapi.ts:273, src/server/xapi.ts:288, src/server/xapi.ts:344, migrations/0004_settings_and_saved.sql:8, src/server/app.ts:190
